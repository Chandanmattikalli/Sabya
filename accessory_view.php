     ...
     <div id="templatemo_content">
         <ul>
            ...
            <div id="templatemo_content_left">
                ...
                $sql="select * from abidder where aname='$aname' and biddername='$biddername';"; 
                $res =  mysql_query($sql);
                $num_rows=mysql_num_rows($res);
                if($num_rows>0)
                {
                    $sql="select * from accessories where name='$aname';"; 
                $res =  mysql_query($sql);
                ...
                echo"<img src='atry.php?id=$aname' width='100px' height='100px'/>";
                echo "<TEXTAREA rows=10 cols=50  readonly>Name:$aname\n Description:$desc\n Category:$cat\n Posted By:$fname $mname $lname\n Phone No.:$phone\n Email:$email\n Room No.:$room\n Price Detail:$price";
                echo"</TEXTAREA><br>";
               ...
               {   
                   $bprice=$_POST['pricetag']; 
                    $sql="update abidder set bprice='$bprice' where biddername='$biddername'";
                    $res =  mysql_query($sql);
                    if($res)
                    {
               ...
               {   
                   ...
                   $sql="select * from signup where username='$biddername';"; 
                    ...
                    $bemail=$row['email'];
                    $bphone=$row['phone'];  
                    $sql="insert into abidder value('$biddername','$bphone','$bemail','$broom','$aname','$sellername','$bprice');";
                    $res =  mysql_query($sql);
                    if($res)
                    {
                        header("Location: bidding.php?id=$biddername");
