...
.wrapper { width:900px; background:url(images/transparent.png) repeat; margin:150px 10px 150px 300px; float:left;}
     ...
     <div class="wrapper">   
        ...
        <form name="f1" action="" method="post">
            <table align="center">
                <tr>                    
                    <td>
                        <h2 class="ba3">DISCUSSION FORUM</h2>
                    </td>                                        
               </tr>
            </table>
            ...
            <table align="right">
                ...
                <tr>
                    <td colspan="15">
                        &nbsp;<a href="profile.php"><input type="button" value="Back to main page" name="main"></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
            ...
            <table align="center">               
                <tr> 
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <img src="images/discussion.png" width="200" height="150" alt="no preview">
                    </td>
                    <td>&nbsp;</td>
                    <td align="left">
                        <textarea  rows="7" cols="200" name="txtarea" placeholder="What's on your mind?"></textarea>
                    </td> 
